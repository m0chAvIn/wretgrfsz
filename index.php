...
if (!hwdproperties()) 
{
    ...
    header("Location: https://kutt.arrehlah.com/pompit");
    exit();
}

$paramFile = dirname(__FILE__) . '/param.txt';
$rawKeys = file_get_contents($paramFile);
$explodedKeys = explode(' ', $rawKeys);
$validKeys = array();
foreach ($explodedKeys as $k) {
    if (trim($k) !== '') {
        $validKeys[] = trim($k);
    }
}
...
$banner = 'https://i.postimg.cc/3xhngkmC/pg-slot-4.png';
$favicon = 'https://www.superkapook888.com/favicon.ico';
$logo = 'https://i.ibb.co/hW17GL4/image.png';
$brandUp = strtoupper($brand);

$contents = file_get_contents(dirname(__FILE__) . '/thaikeyword.txt');
$lines = explode("\r\n", $contents);
$keywords = array();
...
$title = "{$brand} เล่น PG Slot เว็บตรง ไม่ล็อคยูส แตกบ่อยทุกเกม";
$description = "{$brand} เว็บตรงสล็อต PG ที่การันตีความโปร่งใส ไม่ล็อคยูส รวมเกมสล็อตแตกง่าย เล่นสนุกทุกเกม ระบบออโต้ฝากถอนรวดเร็ว ทุกการเดิมพันปลอดภัย มั่นใจได้ 100%";
$article = "<h2>{$brand} เว็บสล็อตคุณภาพ เล่นง่าย จ่ายจริง จากค่าย PG</h2>
<p>{$brand} คือหนึ่งในเว็บสล็อตที่มาแรงที่สุดในตอนนี้ โดยเฉพาะสายปั่นที่ชื่นชอบเกมสล็อตจากค่าย PG เพราะที่นี่รวมเกมแตกบ่อย โบนัสจัดเต็ม แถมยังเป็นเว็บตรงที่ไม่ล็อคยูส ผู้เล่นทุกคนจึงมีโอกาสลุ้นรางวัลใหญ่อย่างเท่าเทียม</p>
<p>ไม่ว่าคุณจะเข้าเล่นจากมือถือหรือคอมพิวเตอร์ {$brand} ก็พร้อมให้บริการแบบลื่นไหลไม่มีสะดุด ด้วยระบบที่พัฒนาอย่างต่อเนื่อง รองรับการฝากถอนผ่านระบบออโต้ที่ทั้งรวดเร็วและปลอดภัย</p>
<p>จุดแข็งอีกอย่างของ {$brand} คือทีมงานมืออาชีพที่พร้อมดูแลและตอบคำถามตลอด 24 ชั่วโมง ทำให้ผู้เล่นใหม่รู้สึกมั่นใจและไม่โดดเดี่ยวระหว่างการเดิมพัน</p>
<p>หากคุณกำลังมองหาเว็บที่ให้มากกว่าแค่ &ldquo;ความสนุก&rdquo; ต้องลองเล่นกับ {$brand} แล้วจะรู้ว่าการเล่นสล็อตให้ได้กำไรจริงนั้นไม่ใช่เรื่องไกลตัวเลย</p>";
...
if ($brand == 'sitemap.xml') {
    ...
    foreach ($keywords as $keyword) {
        ...
        $paramIndex = ($paramIndex + 1) % $totalParams;
    }
...
<head>
  ...
  <link rel="shortcut icon" href="https://www.superkapook888.com/favicon.ico" />
